...
const seedData = async () => {
  try {
    ...
    await Order.deleteMany(); // $0 revenue, 0 orders
    ...
    console.log('🏷️ Seeding 20 Popular Gaming Categories...');
    const popularGames = [
    ...
    console.log('🎮 Seeding Gaming Top-Up & Pass Products...');
    // Gaming Products (60% all-inclusive pricing covering dual-currency processing, VAT, server maintenance & fair staff wages)
    ...
    // Zero dummy orders seeded!
    console.log('✅ Seeding complete with 20 Popular Gaming Categories, 0 dummy orders, and $0 revenue!');
    process.exit(0);
  } catch (error) {
